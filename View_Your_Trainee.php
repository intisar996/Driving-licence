     ...
     <span class="navbar-toggler-icon"></span>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
         <ul class="navbar-nav ml-auto">
                     <li class="nav-item">
            <a class="nav-link" href="trainerhomepage.php">Back</a>
          </li>
...
<?php
    ...
    $q="select * from   tbldetailstrainng a,  tblselecttraineer b , tbltrainer c, tbltrainee d where  d.trainee_uname=b.trainee_username and        a.deid=b.deid and  b.username=c.username  and  c.username='$username'   ";
...
echo"<th class='border border-info'> PRICE(OMR)";
echo"<th class='border border-info'>  Trainer User Name";
echo"<th class='border border-info'>  Trainee User Name";
...
echo"<td class='border border-info'><a href='Moreinfo_trainer2.php?username=$username&&deid=$deid&&trainee_uname=$usernam'>MORE DETAILS</a>";
