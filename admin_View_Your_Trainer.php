...
<?php
    ...
    include('connect.php');
$q="select * from  tbltrainer  where status='NEW'   ";
...
echo"<td class='border border-info'><a href='Approve.php?username=$username'>APPROVE</a>";
 echo"<td class='border border-info'><a href='disApprove.php?username=$username'>DISAPPROVE</a>";
