...
<br /><br />
    ...
    <form   method="post" action="<?php echo "updatepwdatreiner.php?username=$username";?>" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data" >
	   <br />
		<br />
