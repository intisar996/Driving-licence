    ...
    <section id="services" class="services services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2 class="auto-style3">WELCOME TO Driving License Trainer</h2>
        </div>

        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon"><i class="fa  fa-search"></i></div>
            <h4 class="title"><a href="searchtrainer.php">Search Trainer</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon"><i class="fa fa-user"></i></div>
            <h4 class="title"><a href="View_Your_Trainer.php">View Your Trainer</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon"><i class="fa  fa-key"></i></div>
            <h4 class="title"><a href="treinee_Changepassword.php">Change Password</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon"><i class="fa fa-user"></i></div>
            <h4 class="title"><a href="treinee_UpdateProfile.php">Your Profile</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon"><i class="fa fa-paper-plane"></i></div>
            <h4 class="title"><a href="feedback.php">FeedBack</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="300">
