...
$username= $_GET['username'];
    ...
    include('connect.php');
$q="select * from   tbldetailstrainng a,  tbltrainer b  where a.username=b.username and a.username='$username' and a.num_trainees!=0  ";
...
if($num==0)
{
 echo "<h3>This Trainer Not Insert Any details yet  </h3>";
}
else
{
...
echo"<td class='border border-info'><a href='selectTraineer.php?username=$username&&deid=$deid'>Select</a>";
