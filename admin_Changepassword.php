	   ...
	   <br />
		...
		<table align="center" cellpadding="2" class="table table-striped" style="width: 42%; height: 241px">
			...
			<tr>
				...
				Old password:</td>
				<td class="auto-style7" style="height: 38px; width: 323px">
				<input name="opwd" type="password" class="form-control" style="width: 97%; height: 26px" id="opwd" /></td>
			</tr>
			<tr>
				<td class="auto-style7" style="height: 38px; width: 157px">
				new password: </td>
				<td class="auto-style7" style="height: 38px; width: 323px">
				<input id="npwd" name="npwd" style="width: 224px" type="password"></td>
			</tr>
			<tr>
				<td class="auto-style7" style="width: 157px">repate password :</td>
				<td class="auto-style7" style="width: 323px">
				<input name="nrpwd" type="password" class="form-control" style="width: 97%; height: 26px" id="nrpwd" /></td>
			</tr>
			<tr>
