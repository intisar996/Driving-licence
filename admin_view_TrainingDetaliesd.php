     ...
     <span class="navbar-toggler-icon"></span>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
         <ul class="navbar-nav ml-auto">
                     <li class="nav-item">
            <a class="nav-link" href="admin_View_disAprove_Trainer.php">Back</a>
          </li>
...
<?php
   ...
   $username=$_GET['username'];
	...
	$q="select * from   tbldetailstrainng a,tbltrainer d  where      a.username=d.username and   d.username='$username'   ";
...
echo"</table><br>";
	...
	echo "<center>This user has not added any training details! <br></center>";
