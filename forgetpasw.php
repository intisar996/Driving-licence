...
$q="select * from  tbladmin where ausername='$usernamea' ";
...
?>
    ...
    <form   method="post"  action="<?php echo "checkadminanswer.php?ausername=$usernamea";?>" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data"  >
	   <br />
		<br />
