...
$usernam=$_GET['trainee_uname'];
    ...
    include('connect.php');
$q="select * from    tblselecttraineer   where trainee_username='$usernam'     ";
...
if($num==0)
{
 echo "<h3>Treinee not selected trainer yet  </h3>";
}
else
{
...
echo"<td class='border border-info'><a href='Moreinfo_trainer3.php?deid=$deid&&trainee_username=$usernam&&username=$username'>MORE DETAILS</a>";
