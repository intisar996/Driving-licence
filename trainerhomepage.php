      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="100">
            ...
            <h4 class="title"><a href="Add_training_details.php">Add Training Details</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon"><i class="fa fa-search"></i></div>
            <h4 class="title"><a href="View_details_training1.php">View Details Training</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon"><i class="fa  fa-key"></i></div>
            <h4 class="title"><a href="treiner_Changepassword.php">Change Password</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon"><i class="fa fa-user"></i></div>
            <h4 class="title"><a href="treiner_updateProfile.php">Your Profile</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon"><i class="fa fa-paper-plane"></i></div>
            <h4 class="title"><a href="View_Your_Trainee.php">View Your Trainee</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 icon-box" data-aos="zoom-in" data-aos-delay="300">
