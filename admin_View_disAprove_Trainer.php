...
<?php
    ...
    include('connect.php');
$q="select * from  tbltrainer  where status='DIS APPROVE' LIMIT  $start_from,$num_per_page  ";
...
echo "<td><a onClick=\"javascript: return confirm('Please confirm deletion');\" href='Delete2.php?username=$username'>DELETE</a>";
