...
<br /><br />
 ...
 <table align="center" cellpadding="2" class="table table-striped" style="width: 41%; height: 240px">
			...
			<tr>
				...
				<input name="Submit1" style="width: 74px; font-weight: bold; font-size: large; font-family: 'Bernard MT Condensed';" type="submit" value="Submit" class="input btn-outline-info" /><span class="auto-style14">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</span>
