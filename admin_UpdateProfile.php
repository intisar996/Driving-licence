...
?>
    ...
    <form id="form2" name="form2" method="post" action="<?php echo"admin_updateProfile1.php?ausername=$usernamea" ;?>" onsubmit="return validate(this);">
 ...
 <table align="center" cellpadding="2" class="table table-striped" style="width:524px; height: 100px;">
        ...
        <span class="text-white-50">
				<input id="trainee_email" name="email"  placeholder="Enter Your Email" style="width: 99%; height: 33px; font-family: 'Times New Roman', Times, serif;" class="form-control mb-1" value="<?php echo "$emaile"; ?>" readonly="readonly" /></td>
			</tr>
			<tr>
             ...
             <span>
        <span class="text-white-50">
				<input id="trainee_phone" name="phone" placeholder="Enter Your Phone Number" style="width: 99%; height: 33px; font-family: 'Times New Roman', Times, serif;" class="form-control mb-1" value="<?php echo "$phonee"; ?>" readonly="readonly" /></td>
			</tr>
			<tr class="auto-style11">
			...
			<input id="address" class="form-control mb-1" name="address" style="width: 99%; height: 33px" type="text" placeholder="Enter Your Phone Number" value="<?php echo "$addresse"; ?>" readonly="readonly" /></td>
			</tr>
				<script>
