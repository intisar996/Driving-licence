...
$q="select * from  tbltrainer where username='$username' ";
...
?>
    ...
    <form   method="post"  action="<?php echo "checktreineranswer.php?username=$username";?>" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data"  >
	   <br />
		<br />
