...
<br />
    ...
    <form   method="post" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data"  action="treiner_Changepasswordcode.php">
	   <br />
		<br />
		<table align="center" cellpadding="2" class="table table-striped" style="width: 42%; height: 241px">
			...
			<tr class="auto-style10">
				<td class="auto-style7" style="height: 38px; width: 157px">
				Treiner UserName </td>
				<td class="auto-style7" style="height: 38px; width: 323px">
				<?php echo $username;?>&nbsp;</td>
			</tr>
			<tr>
				<td class="auto-style12" style="height: 38px; width: 157px">
				Old password:</td>
				<td class="auto-style7" style="height: 38px; width: 323px">
				<input name="opwd" type="password" class="auto-style11" style="width: 97%; height: 26px" id="opwd" /></td>
			</tr>
			<tr>
				<td class="auto-style12" style="height: 38px; width: 157px">
				new password: </td>
				<td class="auto-style7" style="height: 38px; width: 323px">
				<input id="npwd" name="npwd" style="width: 97%; height: 26px;" type="password" class="auto-style11"></td>
			</tr>
			<tr>
				<td class="auto-style12" style="width: 157px">repate password :</td>
				<td class="auto-style7" style="width: 323px">
				<input name="nrpwd" type="password" class="auto-style11" style="width: 97%; height: 26px" id="nrpwd" /></td>
			</tr>
			<tr>
				<td class="auto-style6" colspan="2">
				<input name="change" style="width: 74px; font-family: 'Times New Roman', Times, serif;" type="submit" value="submit" class="input btn-outline-primary"/><span class="auto-style10">&nbsp;
				</span>
				<input name="Cancel" style="width: 74px; font-family: 'Times New Roman', Times, serif;" type="reset" value="Cancel" class="input btn-outline-primary" /></td>
			</tr>
		</table>
   </form>
   	<br />
